<script lang="ts">
	...
	const toastMessages: Record<string, { kind: 'success' | 'error' | 'info'; text: string }> = {
		...
		storefront_current: { kind: 'success', text: 'Storefront identity marked current' },
		storefront_closed: { kind: 'info', text: 'Storefront marked closed or vacant' },
		storefront_unresolved: { kind: 'info', text: 'Storefront kept unresolved' },
		resolve_failed: { kind: 'error', text: 'Storefront resolve failed' },
